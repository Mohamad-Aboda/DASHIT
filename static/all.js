function lineStack(){
    ...
    option = {
        ...
        legend: {
            data: ['DashIt1', 'DashIt2', 'DashIt3', 'DashIt4', 'DashIt5']
        },
        grid: {
            left: '3%',
            right: '4%',
        ...
        xAxis: {
            type: 'category',
            boundaryGap: false,
            data: ['DashIt1', 'DashIt2', 'DashIt3', 'DashIt4', 'DashIt5', 'DashIt6']
        },
        yAxis: {
            type: 'value'
        },
...
function barWaterfall(){
    var chartDom = document.getElementById('3');
    var myChart = echarts.init(chartDom);
    var option;
...
function datasetSeries(){
    var chartDom = document.getElementById('5');
    var myChart = echarts.init(chartDom);
    var option;
...
function calenderHeatMap(){
    var chartDom = document.getElementById('6');
    var myChart = echarts.init(chartDom);
    var option;
...
function candleStick(){
    var chartDom = document.getElementById('7');
var myChart = echarts.init(chartDom);
var option;
...
function baryCategory(){
    var chartDom = document.getElementById('8');
    var myChart = echarts.init(chartDom);
    var option;
